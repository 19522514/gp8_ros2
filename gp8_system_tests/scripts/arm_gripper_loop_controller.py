...
class ArmGripperLoopController(Node):
    ...
    def __init__(self):
        ...
        self.target_pos = [1.543, 0.787, 0.765, -3.173, 0.573, -2.5]
    ...
    def send_gripper_command(self, position: float) -> None:
        ...
        Args:
            position (float): Position value for gripper (0.0 for open, 0.032 for closed)
        """
    ...
    def control_loop_callback(self) -> None:
        ...
        self.send_gripper_command(0.032)  # Close gripper
